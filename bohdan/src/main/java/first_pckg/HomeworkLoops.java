...
public class HomeworkLoops {
	static void printFirstSequence() {
	...
	static void printSecondSequence() {
	...
	static void printThirdSequence() {
	...
	static void printFourthSequence() {
	...
	static void translateToNotation(int num, int notation) {
		/*
	...
	public static void main(String[] args) {
		...
		translateToNotation(num, notation);
