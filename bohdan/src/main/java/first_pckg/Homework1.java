...
public class Homework1 {
	...
	static void sixthToTenthVariablesTasks(byte b, short s, int i, long l) {
		 ...
		 * деленных на третью переменную типа byte 8. Переменной типа int передать
		 * результат деления двух short, умноженных на результат деления двух byte
		 */
		b = (byte) (b + b);
	...
	public static void main(String[] args) {
		 ...
		 * 5. Инициализировать переменную типа long результатом умножения двух любых
		 * чисел
		 */
		byte b = 2 + 5;
		short s = 10 - 3;
		...
		long l = 5 * 5;
		System.out.println("byte = " + b + "\nshort = " + s + "\nint = " + i + "\nlong = " + l + "\n");
		sixthToTenthVariablesTasks(b, s, i, l);
	}
