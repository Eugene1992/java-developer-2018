...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        productThree.setCategory(catTwo);
        ...
        productFour.setCategory(catTwo);
        ...
        orderOne.setProducts(new Product[]{productOne, productTwo});
        ...
        orderTwo.setProducts(new Product[]{productOne, productThree});
        ...
        orderThree.setProducts(new Product[]{productOne, productFour});
        ...
        orderFour.setProducts(new Product[]{productThree, productTwo});
        ...
        userOne.setOrders(new Order[]{orderOne, orderFour});
        ...
        userTwo.setOrders(new Order[]{orderOne, orderThree});
        ...
        userThree.setOrders(new Order[]{orderTwo, orderThree});
        ...
        userFour.setOrders(new Order[]{orderThree, orderFour});
        ...
        System.out.println("user " + userOne.getFirstname() + " has bought " + User.purchaceGoods(userOne, catOne) + " goods from category " + catOne.getCategory());
        System.out.println();
